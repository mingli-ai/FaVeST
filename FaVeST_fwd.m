...
% OUTPUTS:
%  F1,F2  - Fourier coefficients for divergence-free and curl-free vector
%  spherical harmonics of degree L,m
% TDivhat1 = fftS2(T(:,1),X,L+1,w);     % of size (2L+3)*(L+2)
% TDivhat2 = fftS2(T(:,2),X,L+1,w);     % of size (2L+3)*(L+2)
% TDivhat3 = fftS2(T(:,3),X,L+1,w);     % of size (2L+3)*(L+2)
